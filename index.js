...
client.on('message', async msg => {
    ...
    if (text === 'بداية' || text === 'قائمة') {
    ...
    else if (text === 'أستقبال' || text ==== 'استقبال'|| text ===='خطوات الأستقبال') {
        await msg.reply("🧴 *خطوات الأستقبال:* \n1. أبتسامة عشان محترمين \n2. ما نثقل دمنا على الناس .. \n3. ما بنتأخر في الدوام لانو عنا أهل يسئلو علينا");
    }
    else if (text === 'تعقيم'|| text === 'تعليمات التعقيم' || text ===='خطوات التعقيم'|| text ==== 'أجراءات التعقيم' ) {
        ...
        await msg.reply(
            ...
            "1. إجراءات التشغيل (SOPs)\n" +
            "2. جداول المناوبات اليومية\n" +
            "3. تعليمات العمليات (Operations Instructions)\n" +
            "4. جدول دوام الأمن (PDF)\n\n" +
